define(["require", "exports", "./component2d"], function (require, exports, component2d_1) {
    ...
    class Component5 extends component2d_1.Component2D {
        /**
         * 构造函数
        ...
        constructor(id) {
            ...
            // 颜色数组
            this.colorList = ['#2C9BFE', '#5A598E', '#54C37A'];
            // json
            this.json = [
                [
                    {
        ...
        drawMarkers() {
            ...
            for (let i = 0; i <= this.totalYNumber; i++) {
                ...
                // 设置文字与y轴上横线的位置
                let xMarker = this.originX - 15; // 减去15表示相对于x往左移动15个像素
     ...
     */
        ...
        drwaInstructions() {
            ...
            this.ctx.arc(55, 30, 15, 0, Math.PI * 2);
            this.ctx.fill();
            this.ctx.closePath();
            // 2. 绘制文字
            this.ctx.fillStyle = '#C8CDD6';
            this.ctx.font = '18px Arial';
            this.ctx.fillText('8', 55, 37);
            this.ctx.fillText('历史数据', 115, 37);
            // 绘制文字
            this.ctx.font = '14px Arial';
