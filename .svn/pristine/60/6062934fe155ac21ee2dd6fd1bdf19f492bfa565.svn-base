...
export class Component8 extends Component2D {
    // 定义需要用到的变量
 ...
 */
     ...
     * 绘制标记
     */
    private drawMarkers(dataArr: any){
        if (dataArr) {
        // 先清空
        ...
        let start: string = dataArr[0][0].time;
        // 取第一个数组的最后一个对象的时间
        let end: string = dataArr[0][dataArr[0].length - 1].time;
     ...
     * @param dataArr json数据
     */
    private drawLineAnimate(dataArr: any){
