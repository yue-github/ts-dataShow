...
define(["require", "exports", "./component2d"], function (require, exports, component2d_1) {
    ...
    class Component1 extends component2d_1.Component2D {
        constructor(id) {
            super(id);
            this.canvas6Json = [];
            this.canvas6JsonClone = [];
        ...
        setTarget(arg = null) {
            arg.then(arg => {
                ...
                if (arg) {
                    ...
                    let allCount = 0;
                    this.canvas6JsonClone.forEach((e, i) => {
                        allCount += e.count;
                    });
        ...
        update() {
            ...
            if (this.canvas6Json) {
                ...
                this.canvas6Json.forEach((e, i) => {
                    let hypotenuse = this.circleR * 0.88, angle = Math.PI / 180;
                    // 更新百分比数据
                    this.canvas6Json[i].percent = this.toPercent(this.getTime(3) * (this.canvas6JsonClone[i].count / this.allCount));
                    if (i == 0) {
